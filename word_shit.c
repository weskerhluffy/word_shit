...
static char es_car_descon(char c) {
	return c == HYPHEN || c == APOSTROPHE;
}
static char es_car_valido(char c) {
	char r = 0;
...
static void proc_linea(char *linea, int *conteos, int *carrie) {
